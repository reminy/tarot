...
//	add some logic to use the number of cards in deck
//	add some deck cut logic and some keep ptr to dealt point
//	so no new deal until cards gone.  Not needed for tarot, really
...
// either in big read next spread loop in mem or write to file/index
